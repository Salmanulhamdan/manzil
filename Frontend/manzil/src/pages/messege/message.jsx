        ...
        <div className="w-3/5 p-4 ">
          ...
          >
            ...
            {messages.map((message, index) => (
              <div
                key={index}
                className={`flex mt-4 ${message.sender_email === user.email
                    ? "justify-end"
                    : "justify-start"
                  }`}
              >
            ...
            {profiles
              ? profiles.map((profile) => (
                <div
                  ...
                  className={`flex items-center p-3 cursor-pointer ${selectedProfile === profile.id ? "bg-purple-100" : "bg-gray-100"
                ...
                >
                  ...
                  <button className="bg-red-400 text-white px-2 py-2 hover:bg-red-600 focus:outline-none mt-2 ml-3 rounded-md" onClick={() => {
                    createRoom(); joinChatroom(profile.id);
                    setTrigger(true);
